  ...
  return (
    <div className="lg:flex lg:justify-between lg:items-center mt-10 p-4">
      <div className="lg:max-w-[570px]">
        ...
        <p className="text-sm text-gray-600 text-center lg:text-left my-4">Explore thousands of job opportunities with
          all the information you need. Its your future. Come find it. Manage all your job application from start to
          finish.</p>
